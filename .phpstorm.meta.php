...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\IT-STEP-Academy\Project\Booking_app\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\IT-STEP-Academy\\Project\\Booking_app\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'profile','profile.update','profile.password.change','profile.avatar.update',
'testimonial.store','logout','login','register','home','about','service','contact',
'packages','booking','destination','testimonials','team',
'storage.local',);
        registerArgumentsSet('views', 
'about','auth.login','auth.register','booking','bookings.index',
'components.about','components.booking','components.contact','components.destination','components.packages',
'components.process','components.services','components.team','components.testimonial','contact',
'destination','home','layouts.app','packages','partials.footer',
'partials.header','profile','profile.index','services','team',
'testimonials','testimonials.edit','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
