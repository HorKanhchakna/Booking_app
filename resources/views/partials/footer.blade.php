        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="{{ url('/privacy') }}" class="text-white text-decoration-none">Privacy Policy</a></li>
                    <li class="mb-2"><a href="{{ url('/terms') }}" class="text-white text-decoration-none">Terms & Conditions</a></li>
                    <li class="mb-2"><a href="{{ url('/faq') }}" class="text-white text-decoration-none">FAQs & Help</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>123 Beach Road, Phuket, Thailand</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+66 123 456 789</p>
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@phukettravel.com</p>
                <div class="d-flex pt-2">
                    <a class="btn btn-outline-light btn-social" href="#"><i class="fab fa-twitter"></i></a>
                    <a class="btn btn-outline-light btn-social" href="https://www.facebook.com/proek.juusa/"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p>Subscribe to get the latest travel deals and tips for your trip to Phuket.</p>
