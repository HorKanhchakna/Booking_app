...
<div class="container-fluid bg-dark px-5 d-none d-lg-block">
    ...
    <small class="me-3 text-light">
        <i class="fa fa-map-marker-alt me-2"></i>123 Beach Road, Phuket, Thailand
    </small>
    <small class="me-3 text-light">
        <i class="fa fa-phone-alt me-2"></i>+66 123 456 789
    </small>
    <small class="text-light">
        <i class="fa fa-envelope-open me-2"></i>info@phukettravel.com
    </small>
</div>
