        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    {{-- Place this inside your <form> ... </form> --}}
                    @if(session('success'))
                    ...
                    <form action="{{ route('contacts.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a message here" id="message" name="message" style="height: 100px" required>{{ old('message') }}</textarea>
