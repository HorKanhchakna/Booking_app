...
<head>
    <meta charset="utf-8">
    <title>{{ config('app.name') }} - Our Services</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="travel agency, vacation packages, tour services" name="keywords">
    <meta content="Premium travel services and vacation packages" name="description">
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            <a href="{{ route('home') }}" class="navbar-brand p-0">
                <h1 class="text-primary m-0"><i class="fa fa-map-marker-alt me-3"></i>{{ config('app.name') }}</h1>
            </a>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel position-relative">
                ...
                <div class="testimonial-item bg-white text-center border p-4">
                    <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="{{ asset('img/' . $testimonial['image']) }}" style="width: 80px; height: 80px;">
